...
def main():
    ...
    loaded_html = save_html.load_raw_jobs('../data/ground_truth_jobs_2026-02-20_12-03-21.json') 
    ...
    print(df.head())
    df.to_csv('../data/jooble_jobs_gemini.csv', index=False)
